...
# 导入配置
from src.agents.config import get_server_config, get_cors_config
...
def load_config():
    ...
    try:
        ...
        config_manager = initialize_config(runtime_root=runtime_root, env_prefix='AI_TOYS')
...
if __name__ == "__main__":
    ...
    uvicorn.run("src.agents.main:app", host=host, port=port, reload=False)
